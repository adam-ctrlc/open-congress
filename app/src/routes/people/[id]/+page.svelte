...
<div class="border-b border-gray-200 bg-white">
	<div class="mx-auto max-w-5xl px-4 py-10">
		...
		<div class="flex flex-col gap-5 sm:flex-row sm:items-center">
			<span
				class="flex h-20 w-20 shrink-0 items-center justify-center rounded-2xl bg-primary-100 text-2xl font-800 text-primary-700"
			>
				{initials(person)}
			</span>
			<div>
				...
				{#if senateLink}
					<a
						...
						target="_blank"
						rel="noreferrer"
						class="mt-3 inline-flex items-center gap-1.5 text-sm font-600 text-primary-600 hover:text-primary-700"
					>
	...
	<div class="grid gap-8 lg:grid-cols-3">
		<aside class="space-y-6 lg:sticky lg:top-24 lg:col-span-1 lg:self-start">
			<section>
				<h2 class="mb-3 flex items-center gap-2 text-lg font-700 text-gray-900">
					<Fa icon={faLayerGroup} class="text-primary-600" /> Service
				</h2>
				<dl class="space-y-3 rounded-xl border border-gray-200 bg-white p-4">
			...
			<section>
				<h2 class="mb-3 flex items-center gap-2 text-lg font-700 text-gray-900">
					<Fa icon={faBuildingColumns} class="text-primary-600" /> Memberships
				</h2>
		...
		<section class="lg:col-span-2">
			<h2 class="mb-4 flex items-center gap-2 text-lg font-700 text-gray-900">
				<Fa icon={faFileLines} class="text-primary-600" /> Authored bills
			</h2>
			<div class="mb-4">
				<Toolbar
